...
def get_cars(request):
    # Seed the catalogue when either table is empty.  Checking only CarMake
    # allowed a database with makes but no models to return an empty dropdown.
...
def get_dealer_reviews(request, dealer_id):
    ...
    if(dealer_id):
        ...
        for review_detail in reviews:
            ...
            print(response)
            review_detail['sentiment'] = (response or {}).get('sentiment', 'neutral')
